...
public class GenericPageBean<T> implements AbstractPageBean<T>, Serializable {
	...
	public GenericPageBean(int pageNo, int totalCount, List<T> elements) {
		this(pageNo, PageConfiguration.DEFAULT_PAGE_SIZE, totalCount, elements);
	}
	...
	public GenericPageBean(int pageNo, int pageSize, int totalCount,
		...
		this(pageNo, pageSize, totalCount, elements,
				PageConfiguration.DEFAULT_PAGINATION);
	}
	...
	public GenericPageBean(int pageNo, int pageSize, int totalCount,
		...
		if (pageSize <= 0) {
			this.pageSize = PageConfiguration.DEFAULT_PAGINATION;
		} else {
		...
		if (pagination == 0) {
			pagination = PageConfiguration.DEFAULT_PAGINATION;
		} else if (pagination < PageConfiguration.MIN_PAGINATION
				|| pagination > PageConfiguration.MAX_PAGINATION) {
			pagination = PageConfiguration.DEFAULT_PAGINATION;
		}
