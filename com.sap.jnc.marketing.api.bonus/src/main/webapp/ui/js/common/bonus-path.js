...
PATH.PORTAL = {
    ...
    TO_TERMINAL_LIST: HTML_ROOT + '/terminal.html',
    TO_TERMINAL_ADD_ONE: HTML_ROOT + '/terminal_add_one.html',
    TO_TERMINAL_ADD_TWO: HTML_ROOT + '/terminal_add_two.html',
    TERMINAL_ACCOUNT: ROOT + 'terminal/account',
    TO_TERMINAL_ACCOUNT_ADD: HTML_ROOT + 'terminal_account_add.html',
    ...
    TO_SALESMAN_ORDERS: HTML_ROOT + '/salesOrderSuccess.html',
