...
public class JFUpdateRequest implements Serializable {

	private static final long serialVersionUID = -6666608436243790048L;
	@Valid
	private List<JFUpdateDelRequestItem> items;

	public List<JFUpdateDelRequestItem> getItems() {
		return items;
	}

	public void setItems(List<JFUpdateDelRequestItem> items) {
		this.items = items;
	}

	public static class JFUpdateDelRequestItem implements Serializable {

		private static final long serialVersionUID = 1312025752128669787L;
